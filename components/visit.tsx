        ...
        <div className="grid gap-12 md:grid-cols-2 md:gap-16">
          <div>
            ...
            <p className="mt-6 max-w-md text-pretty leading-relaxed text-background/70">
              삼성중앙역 5번 출구에서 도보 3분. 강남 봉은사로의 조용한 골목, 아이보리빛 예쁜 건물
              1층에서 오더에스프레소를 만나보세요.
            </p>
            ...
            <dl className="mt-10 space-y-6">
              <div className="border-t border-background/20 pt-5">
                ...
                <dd className="mt-2 leading-relaxed">서울 강남구 봉은사로 82길 27, 1층 · 지1층</dd>
              </div>
              <div className="border-t border-background/20 pt-5">
                <dt className="text-xs uppercase tracking-widest text-background/50">Hours</dt>
                <dd className="mt-2 space-y-1">
                  {hours.map((h) => (
                    <div key={h.day} className="flex items-baseline gap-4">
                      <span className="w-16 text-background/80">{h.day}</span>
                      <span className="tabular-nums leading-relaxed">{h.time}</span>
                    </div>
                  ))}
                </dd>
              </div>
              <div className="border-t border-background/20 pt-5">
                <dt className="text-xs uppercase tracking-widest text-background/50">Directions</dt>
                <dd className="mt-2 leading-relaxed text-background/80">
                  삼성중앙역 5번 출구에서 90m 직진 후, 봉산집·삼진빌딩 골목으로 좌회전.
                  GS편의점 사거리에서 우측으로 조금 내려오면 좌측 아이보리빛 건물입니다.
                </dd>
              </div>
              <div className="border-t border-background/20 pt-5">
              ...
              <div className="border-t border-background/20 pt-5">
                <dt className="text-xs uppercase tracking-widest text-background/50">Contact</dt>
          ...
          <div className="relative min-h-[320px] overflow-hidden rounded-sm md:min-h-full">
            <Image src="/images/counter.jpg" alt="오더에스프레소 매장 카운터 전경" fill className="object-cover" />
          </div>
        </div>
      </div>
    </section>
